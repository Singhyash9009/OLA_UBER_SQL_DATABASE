...
CREATE TABLE 
trips_details1(tripid	integer,loc_from integer,
searches integer,searches_got_estimate integer,
searches_for_quotes integer,searches_got_quotes	integer,
customer_not_cancelled	integer,
driver_not_cancelled integer,otp_entered integer,
end_ride integer); 
...
,loc_from integer,searches integer,searches_got_estimate integer
...
customer_not_cancelled	integer,driver_not_cancelled integer,
otp_entered integer,end_ride integer); 
...
CREATE TABLE  trips_details4 (tripid integer,loc_from integer,
searches integer,searches_got_estimate integer,
searches_for_quotes	integer,searches_got_quotes	integer,
customer_not_cancelled integer,driver_not_cancelled integer,
otp_entered	integer,end_ride integer);
...
select * from trips_details4;
alter table trips_details4 rename to trips_details;
